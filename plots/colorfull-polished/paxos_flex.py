...
# Make the plot
plt.bar(br1, flexlog, color = c.palette[1], width = barWidth, hatch = '/',
        edgecolor ='black', label ='FlexLog')
plt.bar(br2, flexlog_relaxed, color = c.palette[2], width = barWidth, hatch = '*',
        edgecolor ='black', label ='FlexLog (partial ord.)')
plt.bar(br3, paxos, color = c.palette[4], width = barWidth, hatch = 'X',
